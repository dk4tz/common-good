...
export const QUESTIONS: QuestionType[] = [
	{
		...
		responses: {
			...
			'3) The project does not have a comprehensive ToC that outlines intended outcomes and impact ambitions.': 1,
			'4) Unsure': 0
		}
	},
	{
		...
		responses: {
			...
			'3) The project does not survey former direct beneficiaries.': 1,
			'4) Unsure': 0
		}
	},
	{
	...
	},
	{
		...
		responses: {
			...
			'3) The project does not survey the beneficiary population at baseline and/or endline': 1,
			'4) Unsure': 0
		}
	},
	{
	...
	},
	{
		...
		responses: {
			...
			"3) The project does not track or engage other programs working in the same landscape and/or with the same group of beneficiaries, and is unaware of their contribution to the intervention's outcomes.": 1,
			'4) Unsure': 0
		}
	},
	{
		...
		responses: {
			...
			'3) The project does not track external events and does not account for them in its reporting': 1,
			'4) Unsure': 0
		}
	},
	{
		...
		responses: {
			...
			'3) The project does not directly engage beneficiaries and/or does not have the ability to gather project and demographic data on all beneficiaries.': 1,
			'4) Unsure': 0
		}
	},
	{
		...
		responses: {
			...
			'3) The organization does not seek consent from beneficiaries or their representatives before the start of its interventions.': 1,
			'4) Unsure': 0
		}
	},
	{
		...
		responses: {
			...
			'3) The project does not differentiate between intended and unintended outcomes. The reporting does not include negative outcomes and provides an inaccurate assessment of the impact generated by the intervention.': 1,
			'4) Unsure': 0
		}
	},
	{
		...
		responses: {
			...
			'3) The project does not consistently/periodically report on the outcomes of its interventions to external and internal stakeholders.': 1,
			'4) Unsure': 0
		}
	},
	{
		...
		responses: {
			...
			'3) The project does not engage local partners or leaders and/or does not gather feedback from them': 1,
			'4) Unsure': 0
		}
	}
];
