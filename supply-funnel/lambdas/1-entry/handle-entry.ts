...
const MONDAY_FORM_FIELD_LOOKUP: Record<string, any> = {
	...
	status1: 'toc-design',
	long_text: 'toc-design-justfication',
	...
	long_text4: 'beneficiaries-household-data-justification',
	...
	long_text_2: 'periodic-reporting-justification',
	...
	single_select96: 'external-events',
	long_text780: 'external-events-justification',
	single_select60: 'beneficiaries-consent',
	single_select_1: 'partner-engagement',
	long_text_5: 'partner-engagement-justification',
	long_text86: 'beneficiaries-consent-justification',
	true___false: 'impact-profile',
	short_text: 'primary-outcome',
	...
	multi_select: 'outcome-impact-theme',
	long_text_3: 'indicator-metric-tool',
	number1: 'minutes-to-complete-assessment',
	true___false1: 'anonymized-data',
	long_text0: 'feedback'
};
